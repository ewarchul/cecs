...
void cec2014_step_rastrigin_func(double *, double *, int, double *, double *, int,
...
void cec2014_cf_cal(double *, double *, int, double *, double *, double *, double *,
            int);

#endif // CEC2014_FUNCTIONS_H
