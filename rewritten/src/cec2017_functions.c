#include "../include/cec2017_functions.h"
                             ...
                             int r_flag) /* Bent_Cigar */
{
  ...
  cec2017_sr_func(x, z, nx, Os, Mr, 1.0, s_flag, r_flag, y); /* shift and rotate */
...
/*void cec2017_zakharov_func(double *x, double *f, int nx, double *Os, double
 * *Mr,*/
...
/*void cec2017_griewank_func(double *x, double *f, int nx, double *Os, double
 * *Mr,*/
...
/*void cec2017_schwefel_func(double *x, double *f, int nx, double *Os, double
 * *Mr,*/
...
/*void cec2017_katsuura_func(double *x, double *f, int nx, double *Os, double
 * *Mr,*/
...
/*void cec2017_hf01(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
...
/*void cec2017_hf02(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
...
/*void cec2017_hf03(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
/*                  int s_flag, int r_flag) [> Hybrid Function 2 <] */
/*{ */
/*  int i, tmp, cf_num = 3; */
...
/*void cec2017_hf04(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
...
/*void cec2017_hf05(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
...
/*  } */
/*} */
/*void cec2017_hf06(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
...
/*void cec2017_hf07(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
...
/*void cec2017_hf08(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
/*                  int s_flag, int r_flag) [> Hybrid Function 6 <] */
/*{ */
/*  int i, tmp, cf_num = 5; */
...
/*void cec2017_hf09(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
/*                  int s_flag, int r_flag) [> Hybrid Function 6 <] */
/*{ */
/*  int i, tmp, cf_num = 5; */
...
/*void cec2017_hf10(double *x, double *f, int nx, double *Os, double *Mr, int
 * *S, */
/*                  int s_flag, int r_flag) [> Hybrid Function 6 <] */
/*{ */
/*  int i, tmp, cf_num = 6; */
...
/*                          r_flag); */
/*  i = 1; */
/*  cec2017_ellips_func(x, &fit[i], nx, &Os[i * nx], &Mr[i * nx * nx], 1,
 * r_flag);*/
...
/*                          r_flag); */
/*  i = 1; */
/*  cec2017_ackley_func(x, &fit[i], nx, &Os[i * nx], &Mr[i * nx * nx], 1,
 * r_flag);*/
/*  fit[i] = 1000 * fit[i] / 100; */
/*  i = 2; */
/*  cec2017_schwefel_func(x, &fit[i], nx, &Os[i * nx], &Mr[i * nx * nx], 1, */
...
/*  fit[i] = 1000 * fit[i] / 100; */
/*  i = 3; */
/*  cec2017_discus_func(x, &fit[i], nx, &Os[i * nx], &Mr[i * nx * nx], 1,
 * r_flag);*/
/*  fit[i] = 10000 * fit[i] / 1e+10; */
/*  i = 4; */
/*  cec2017_rosenbrock_func(x, &fit[i], nx, &Os[i * nx], &Mr[i * nx * nx], 1, */
...
/*  i = 0; */
/*  cec2017_hgbat_func(x, &fit[i], nx, &Os[i * nx], &Mr[i * nx * nx], 1,
 * r_flag); */
...
/*void cec2017_cf09(double *x, double *f, int nx, double *Os, double *Mr, int
 * *SS,*/
/*                  int r_flag) { */
...
/*void cec2017_cf10(double *x, double *f, int nx, double *Os, double *Mr, int
 * *SS,*/
/*                  int r_flag) { */
/*  int i, cf_num = 3; */
/*  double fit[3]; */
...
/*    } */
/*    if (w[i] != 0) */
/*      w[i] = pow(1.0 / w[i], 0.5) * exp(-w[i] / 2.0 / nx /
 * pow(delta[i], 2.0)); */
/*    else */
/*      w[i] = INF; */
/*    if (w[i] > w_max) */
