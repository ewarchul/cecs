...
void cec2021_hf02(double *, double *, int, double *, double *, int *, int,
                  int); /* Hybrid Function 5 */
void cec2021_hf03(double *, double *, int, double *, double *, int *, int,
                  int); /* Hybrid Function 6 */

void cec2021_cf01(double *, double *, int, double *, double *,
                  int); /* Composition Function 2 */
void cec2021_cf02(double *, double *, int, double *, double *,
                  int); /* Composition Function 4 */
void cec2021_cf03(double *, double *, int, double *, double *,
                  int); /* Composition Function 5 */

void cec2021_cf01_s(double *, double *, int, double *, double *,
...
void cec2021_cf03_s(double *, double *, int, double *, double *,
